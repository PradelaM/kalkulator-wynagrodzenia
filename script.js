...
const handleQuiz = (e) => {
	...
	console.log({checkedAnswers,isTrue,allQuestions,allChecked})
	if (!allChecked) {
		modal.classList.add('modal-active');
		modalInfo.textContent = 'zaznacz wszystko baranie';
        return
	}
    ...
    modal.classList.add('modal-active');
    modalInfo.textContent = 'Brawooo Krisuu'
}
else{
    modal.classList.add('modal-active')
    modalInfo.textContent = 'A żeś zdupił'
}
